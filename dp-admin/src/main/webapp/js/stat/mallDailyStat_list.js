$(function(){
	...
	var params = "&statParams['pvFrom']=" + pvFrom + "&statParams['pvTo']=" + pvTo + "&statParams['uvFrom']=" + uvFrom + "&statParams['uvTo']=" + uvTo 
	...
	initLink : function(params) {
		$.each($("a[name='navi_a']"), function(index, val){
			$(this).click(function(){
				...
				window.location.href = basePath+"dp/stat/mallDailyStatListView.action?page.currentPage=" + curPage + params;
			});
		});
	},
	initButton : function(params){
		$("#btn_query").click(function(){
			$("#queryFrm").attr("action",basePath+"dp/stat/mallDailyStatListView.action");
			$("#queryFrm").submit();
		});
		
		$("#btn_exportExcel").click(function(){
			$("#queryFrm").attr("action",basePath+"dp/stat/mallDailyStatList2Excel.action");
			$("#queryFrm").submit();
		});
		...
		$("#goPageBtn").click(function(){
			...
			var url_pre = basePath+"dp/stat/mallDailyStatListView.action?page.currentPage=";
			if(page < 1) {
