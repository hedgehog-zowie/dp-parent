...
var actionManager = {
	initLink : function(params) {
		$.each($("a[name='navi_a']"), function(index, val){
			$(this).click(function(){
				...
				window.location.href = basePath+"dp/stat/gnAppRegisterOfChannelStatView.action?page.currentPage=" + curPage + params;
			});
		});
	},
	initDialog : function(){
	...
	initButton : function(params){
		...
		$("#btn_query").click(function(){
			...
			$("#queryFrm").attr("action",basePath+"dp/stat/gnAppRegisterOfChannelStatView.action");
			$("#queryFrm").submit();
		});
		...
		$("#btn_exportExcel").click(function(){
			...
			$("#queryFrm").attr("action",basePath+"dp/stat/gnAppRegisterOfChannelStat2Excel.action");
			$("#queryFrm").submit();
		});
		...
		$("#goPageBtn").click(function(){
			...
			var url_pre = basePath+"dp/stat/gnAppRegisterOfChannelStatView.action?page.currentPage=";
			if(page < 1) {
	...
	renderChartData : function(flag,beginDate,endDate,appName,channels){
		$.post(basePath+"dp/stat/getGnAppRegisterOfChannelStatByJSON.action", 
			{
				"flag": flag,
