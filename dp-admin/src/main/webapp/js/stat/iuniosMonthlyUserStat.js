...
//	var flag = $("#flag_h").val();
	...
	var params = "&statParams['appName']=" + appName + "&statParams['channelName']=" + channelName 
...
var actionManager = {
	initLink : function(params) {
		$.each($("a[name='navi_a']"), function(index, val){
			$(this).click(function(){
				...
				window.location.href = basePath+"dp/stat/iuniosMonthlyUserStatView.action?page.currentPage=" + curPage + params;
			});
		});
	},
	initDialog : function(){
	...
	initButton : function(params){
		...
		$("#btn_query").click(function(){
			$("#queryFrm").attr("action",basePath+"dp/stat/iuniosMonthlyUserStatView.action");
			$("#queryFrm").submit();
		});
		
		$("#btn_exportExcel").click(function(){
			$("#queryFrm").attr("action",basePath+"dp/stat/iuniosMonthlyUserStat2Excel.action");
			$("#queryFrm").submit();
		});
		...
		$("#goPageBtn").click(function(){
			...
			var url_pre = basePath+"dp/stat/iuniosMonthlyUserStatView.action?page.currentPage=";
			if(page < 1) {
