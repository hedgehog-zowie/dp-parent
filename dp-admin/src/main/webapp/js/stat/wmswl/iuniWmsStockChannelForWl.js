...
var actionManager = {
    ...
    initLink: function (params) {
        $.each($("a[name='navi_a']"), function (index, val) {
            $(this).click(function () {
                ...
                window.location.href = basePath + "dp/stat/iuniWmsStockChannelForWl.action?page.currentPage=" + curPage + params;
            });
        });
    },
    initButton: function (params, page1Index, page2Index) {
        ...
        $("#btn_query").click(function () {
            $("#queryFrm").attr("action", basePath + "dp/stat/iuniWmsStockChannelForWl.action");
            $("#queryFrm").submit();
        });

        $("#btn_exportExcel").click(function () {
            $("#queryFrm").attr("action", basePath + "dp/stat/iuniWmsStockChannelForWl2Excel.action");
            $("#queryFrm").submit();
        });
        ...
        $("#goPageBtn").click(function () {
            ...
            var url_pre = basePath + "dp/stat/iuniWmsStockChannelForWl.action?page.currentPage=";
            if (page < 1) {
