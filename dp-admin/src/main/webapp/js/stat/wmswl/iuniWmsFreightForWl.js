...
//	var flag = $("#flag_h").val();
    ...
    var params = "&statParams['beginDate']=" + beginDate + "&statParams['endDate']=" + endDate + "&direction=" + getCurrDirection();
...
function getCurrDirection() {
    var doc = document.getElementById("direction");
    //alert("direction is " + doc.options[doc.selectedIndex].value);
...
var actionManager = {
    initLink: function (params) {
        $.each($("a[name='navi_a']"), function (index, val) {
            $(this).click(function () {
                ...
                window.location.href = basePath + "dp/stat/iuniWmsFreightForWl.action?page.currentPage=" + curPage + params;
            });
        });
    },
    initButton: function (params) {
        ...
        $("#btn_query").click(function () {
            $("#queryFrm").attr("action", basePath + "dp/stat/iuniWmsFreightForWl.action");
            $("#queryFrm").submit();
        });

        $("#btn_exportExcel").click(function () {
            $("#queryFrm").attr("action", basePath + "dp/stat/iuniWmsFreightForWl2Excel.action");
            $("#queryFrm").submit();
        });
        ...
        $("#goPageBtn").click(function () {
            ...
            var url_pre = basePath + "dp/stat/iuniWmsFreightForWl.action?page.currentPage=";
            if (page < 1) {
