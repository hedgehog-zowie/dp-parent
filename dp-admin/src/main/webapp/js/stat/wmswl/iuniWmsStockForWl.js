...
//	var flag = $("#flag_h").val();
    ...
    var skuCodeStr = $("#skuCodeStr").val();

    var params = "&statParams['beginDate']=" + beginDate + "&statParams['endDate']=" + endDate
        + "&dateStyle=" + dateStyle + "&warehouseCode" + warehouseCode + "&skuCodeStr=" + skuCodeStr;
...
var actionManager = {
    initLink : function(params, page1Index, page2Index) {
        $.each($("a[name='navi_a_1']"), function(index, val){
            $(this).click(function(){
                ...
                window.location.href = basePath+"dp/stat/iuniWmsStockForWl.action?onePage.currentPage=" + curPage
        ...
        $.each($("a[name='navi_a_2']"), function(index, val){
            $(this).click(function(){
                var curPage = $(this).attr("relval");
                window.location.href = basePath+"dp/stat/iuniWmsStockForWl.action?twoPage.currentPage=" + curPage
    ...
    initButton : function(params, page1Index, page2Index){
        ...
        $("#btn_query").click(function(){
            $("#queryFrm").attr("action",basePath+"dp/stat/iuniWmsStockForWl.action");
            $("#queryFrm").submit();
        });

        $("#btn_exportExcel").click(function(){
            $("#queryFrm").attr("action",basePath+"dp/stat/iuniWmsStockForWl2Excel.action");
            $("#queryFrm").submit();
        });
        ...
        $("#goPageBtn_1").click(function(){
            ...
            var url_pre = basePath+"dp/stat/iuniWmsStockForWl.action?onePage.currentPage=";
            if(page < 1) {
        ...
        $("#goPageBtn_2").click(function(){
            ...
            var url_pre = basePath+"dp/stat/iuniWmsStockForWl.action?twoPage.currentPage=";
            if(page < 1) {
