...
<head> 
	...
	<script type="text/javascript" src="js/stat/iuniBuriedPointSite_list.js?v=140320"></script>
...
<body> 
	...
	<tr> 
		...
		<dl>
			<dd class="ddl1">
				<label for="website">站点编码</label>
			</dd>
			<dd class="ddr1">
				<input name="queryParams['websiteCode']" id="websiteCode" type="text" value="${queryParams['websiteCode']}"></input>
			</dd>
			<dd class="ddl1">
	...
	<tbody>
		<s:iterator value="#request.iuniBuriedPointSites" status="s" id="iuniBuriedPointSite">
		<tr>
<%-- 			<td class="mytd"><s:property value="#s.index+1" /></td> --%>
			<td class="mytd"><s:property value="rowNum" /></td>
			<td class="mytd"><s:property value="websiteCode" /></td>
