...
<head>
    ...
    <script type="text/javascript" src="js/stat/iuniOrderRefundDetails.js?v=140718"></script>
...
<table border="0" cellspacing="0" cellpadding="0" class="adminMain_top">
    ...
    <tr>
        <td class="td01"></td>
        <td class="td02"><h3 class="topTitle fb f14">IUNI订单退款明细统计报表</h3></td>
        <td class="td03"></td>
    </tr>
    </tbody>
</table>
        ...
        <td class="adminMain_wrap">
            <div class="wrapMain" style="height:auto;vertical-align: middle;">
                ...
                <table class="listtable" style="width: 100%">
                    ...
                    <tbody>
                    <s:iterator value="#request.iuniOrderRefundDetailsList" status="s" id="iuniOrderRefundDetails">
                        <tr>
                            ...
                            <td class="mytd"><s:date name="logTime" format="yyyy-MM-dd"/></td>
                            ...
                            <td class="mytd"><s:property value="goodsAttr"/></td>
                            ...
                            <td class="mytd"><s:property value="boundsId"/></td>
