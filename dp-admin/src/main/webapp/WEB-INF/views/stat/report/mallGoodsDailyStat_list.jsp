...
<head> 
	...
	<script type="text/javascript" src="js/stat/mallGoodsDailyStat_list.js?v=130710"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">商品访问购买率报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tr> 
		...
		<dl>
			...
			<dd class="ddr1">
				<input type="text" id="gdName" name="statParams['gdName']" value="${statParams['gdName']}"/>
			</dd>
			<dd class="ddl1">
	...
	<tbody>
		<s:iterator value="#request.mallGoodsDailyStatList" status="s" id="mallGoodsDailyStat">
		<tr>
