...
<head> 
	...
	<script type="text/javascript" src="js/stat/wxActiveUserStat.js?v=130808"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">微信活跃用户数统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<caption class="cp1">微信活跃用户数统计报表</caption>
	<thead>
		<tr>
			<th>序号</th>
			<th>统计日期</th>
	...
	<tbody>
		<s:iterator value="#request.activeUserStatList" status="s" id="activeUserStat">
		<tr>
