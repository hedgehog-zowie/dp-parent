...
<head> 
	...
	<script type="text/javascript" src="js/stat/iuniUserLoginNum.js?v=140617"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">IUNI用户登陆次数统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tr> 
		...
		<dl>
			<dd class="ddl1" style="width: 10%">
				<label for="beginDate">登录日期开始</label>
			</dd>
			<dd class="ddr1">
			...
			<dd class="ddl1" style="width: 10%">
				<label for="endDate">登录日期结束</label>
			</dd>
			<dd class="ddr1">
	...
	<tbody>
		<s:iterator value="#request.iuniUserLoginNumList" status="s" id="iuniUserLoginNum">
		<tr>
			...
			<td class="mytd"><s:property value="loginNum" /></td>
		</tr>
		</s:iterator>
	</tbody>
	</table>
