...
<head> 
	...
	<script type="text/javascript" src="js/stat/mallAdPvuvOrderDaily_list.js?v=130607"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">站外推广数据报表(日表)</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tbody>
		...
		<tr>
			...
			<td class="mytd"><s:property value="backOrderNum" /></td>
			<td class="mytd"><a href="<%=basePath%>stat/queryMallAdPvuvOrderDetails.action?detailType=2&bizDate=${bizDate}&adId=${adId}&adName=${adName}&channelName=${channelName}">查看明细</a></td>
		</tr>
		</s:iterator>
	</tbody>
	</table>
