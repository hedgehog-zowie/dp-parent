...
<head> 
	...
	<script type="text/javascript" src="js/stat/iuniPageNetflowDailyStat.js?v=140106"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">IUNI商城页面受访报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tbody>
		<s:iterator value="#request.pageNetflowSumByDateList" status="s" id="pageNetflowSumByDate">
		<tr>
			<td class="mytd"><s:property value="rowNum" /></td>
			<td class="mytd"><s:property value="statDate" /></td>
			<td class="mytd"><s:property value="pageUrl" /></td>
	...
	<tbody>
		<s:iterator value="#request.pageNetflowDailyStatList" status="s" id="pageNetflowDailyStat">
		<tr>
			<td class="mytd"><s:property value="rowNum" /></td>
			<td class="mytd"><s:property value="statDate" /></td>
			<td class="mytd"><s:property value="pageUrl" /></td>
