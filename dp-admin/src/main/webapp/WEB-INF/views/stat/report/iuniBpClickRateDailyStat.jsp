...
<head> 
	...
	<script type="text/javascript" src="js/stat/iuniBpClickRateDailyStat.js?v=140423"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">IUNI商城埋点位置点击率日明细表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tbody>
		<s:iterator value="#request.ibpdClickRateStatList" status="s" id="ibpdClickRateStat">
		<tr>
