...
<head>
    ...
    <script type="text/javascript" src="js/stat/wms/iuniWmsStockDetails.js?v=140708"></script>
...
<table border="0" cellspacing="0" cellpadding="0" class="adminMain_top">
    ...
    <tr>
        <td class="td01"></td>
        <td class="td02"><h3 class="topTitle fb f14">IUNI WMS库存明细报表</h3></td>
        <td class="td03"></td>
    </tr>
    </tbody>
</table>
        ...
        <td class="adminMain_wrap">
            <div class="wrapMain" style="height:auto;vertical-align: middle;">
                ...
                <table class="listtable" style="width: 100%">
                    ...
                    <tbody>
                    <s:iterator value="#request.iuniWmsStockDetailsList" status="s" id="iuniWmsStockDetails">
                        <tr>
                            ...
                            <td class="mytd"><s:property value="defectiveGoods"/></td>
                            <td class="mytd"><s:property value="totalGoods"/></td>
                        </tr>
                    </s:iterator>
                    </tbody>
                </table>
