...
<head> 
	...
	<script type="text/javascript" src="js/stat/gnAppNewUserOfChannelStat.js?v=130916"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">APP渠道新增用户数统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<s:if test="#request.newUserOfChannelStatList != null && !#request.newUserOfChannelStatList.isEmpty()">
	...
	<tbody>
		<s:iterator value="#request.newUserOfChannelStatList" status="s" id="newUserOfChannelStat">
		<tr>
