...
<head>
    ...
    <script type="text/javascript" src="js/stat/wms/iuniStockMovDetails.js?v=140701"></script>
...
<table border="0" cellspacing="0" cellpadding="0" class="adminMain_top">
    ...
    <tr>
        <td class="td01"></td>
        <td class="td02"><h3 class="topTitle fb f14">IUNI WMS销售出库明细报表</h3></td>
        <td class="td03"></td>
    </tr>
    </tbody>
</table>
        ...
        <td class="adminMain_wrap">
            <div class="wrapMain" style="height:auto;vertical-align: middle;">
                ...
                <div class="frame4" style="height:70px;">
                    <form action="" method="post" id="queryFrm">
                        <dl>
                            ...
                            <dd class="ddl1">
                                <label for="orderCode">订单号/外部订单号</label>
                            </dd>
                            <dd class="ddr1">
                ...
                <table class="listtable" style="width: 100%">
                    ...
                    <tbody>
                    <s:iterator value="#request.iuniStockMovDetailsList" status="s" id="iuniStockMovDetails">
                        <tr>
                            ...
                            <td class="mytd"><s:property value="isScalper"/></td>
                        </tr>
                    </s:iterator>
                    </tbody>
                </table>
