...
<head> 
	...
	<script type="text/javascript" src="js/stat/appUserStatOnModel.js?v=140225"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">用户访问机型报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tr> 
		...
		<div class="frame4" style="height:30px;">
			<dl>
				<dd class="ddl1">
					<label for="channels">统计指标</label>
				</dd>
				<dd class="ddr1">
					<select id="statIndex" class="select1" name="statParams['statIndex']">
						<s:if test="statParams['statIndex'] == 'launchNum'">
							<option value="launchNum" selected="selected">
								累计启动次数
							</option>
							<option value="launchUserNum">
								累计启动用户数
							</option>
							<option value="newUserNum">
								累计新用户数
							</option>
							<option value="avgTime">
								平均使用时长
							</option>
						</s:if>
						<s:elseif test="statParams['statIndex'] == 'launchUserNum'">
							<option value="launchNum">
								累计启动次数
							</option>
							<option value="launchUserNum" selected="selected">
								累计启动用户数
							</option>
							<option value="newUserNum">
								累计新用户数
						...
						<s:elseif test="statParams['statIndex'] == 'newUserNum'">
							<option value="launchNum">
								累计启动次数
							</option>
							<option value="launchUserNum">
							...
							<option value="newUserNum" selected="selected">
								累计新用户数
							</option>
							<option value="avgTime">
								平均使用时长
						...
						<s:elseif test="statParams['statIndex'] == 'avgTime'">
							<option value="launchNum">
								累计启动次数
							</option>
							<option value="launchUserNum">
							...
							<option value="avgTime" selected="selected">
								平均使用时长
							</option>
						</s:elseif>
						<s:else>
	...
	<s:if test="#request.appStatOnModelList != null && !#request.appStatOnModelList.isEmpty()">
	...
	<tbody>
		<s:iterator value="#request.appStatOnModelList" status="s" id="appStatOnModel">
		<tr>
			<td class="mytd"><s:property value="rowNum" /></td>
			<td class="mytd"><s:property value="mobileModel" /></td>
			<td class="mytd"><s:property value="launchNum" /></td>
			<td class="mytd"><s:property value="launchUserNum" /></td>
			<td class="mytd"><s:property value="newUserNum" /></td>
			<td class="mytd"><s:property value="avgTime" /></td>
			<td class="mytd"><s:property value="avgTimeFmt" /></td>
			<td class="mytd"><s:property value="newUserRatio" /></td>
		</tr>
		</s:iterator>
	</tbody>
	</table>
