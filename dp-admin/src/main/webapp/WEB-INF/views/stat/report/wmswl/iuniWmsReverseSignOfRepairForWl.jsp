...
<head>
    ...
    <script type="text/javascript" src="js/stat/wmswl/iuniWmsReverseSignOfRepairForWl.js?v=140532"></script>
...
<table border="0" cellspacing="0" cellpadding="0" class="adminMain_top">
    ...
    <tr>
        <td class="td01"></td>
        <td class="td02"><h3 class="topTitle fb f14">逆向签收表 - 维修</h3></td>
        <td class="td03"></td>
    </tr>
    </tbody>
</table>
                        ...
                        <dl>
                            ...
                            <dd class="ddr1">
                                <s:select name="status" listKey="code" listValue="name"
                                          list="repairStatusList" headerKey="" headerValue="全选"></s:select>
                            </dd>
                            <dd class="ddl1"/>
                            <dd class="ddl1">
                ...
                <table class="listtable" style="width: 100%">
                    ...
                    <s:iterator value="#request.result" status="s" id="result">
                        <tr>
                            ...
                            <td class="mytd"><s:property value="repairSn"/></td>
