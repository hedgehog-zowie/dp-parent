...
<head> 
	...
	<script type="text/javascript" src="js/stat/gnAppActiveUserOfChannelStat.js?v=130918"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">APP渠道活跃用户数统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<s:if test="#request.activeUserOfChannelStatList != null && !#request.activeUserOfChannelStatList.isEmpty()">
	...
	<tbody>
		<s:iterator value="#request.activeUserOfChannelStatList" status="s" id="activeUserOfChannelStat">
		<tr>
			<td class="mytd"><s:property value="rowNum" /></td>
			<td class="mytd"><s:property value="channelName" /></td>
			<td class="mytd"><s:property value="activeUserNum" /></td>
