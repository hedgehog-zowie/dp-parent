...
<head> 
	...
	<script type="text/javascript" src="js/stat/snapshotStat_list.js?v130618"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">上报数据间隔快照类型统计分析报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tr> 
		...
		<dl>
			...
			<dd class="ddr1">
				...
				<input type="hidden" id="statSchemeId" name="statSnapshotResultVo.statSchemeId" value="${statSnapshotResultVo.statSchemeId}"/>
			</dd>
			<dd class="ddl2">
			...
			<dd class="ddr2">
				<input type="text" id="sourceId" name="statSnapshotResultVo.sourceId" value="${statSnapshotResultVo.sourceId}"/>
			</dd>
			<dd class="ddl1">
				<label for="snapshotTime">统计分析时间</label>
			</dd>
			<dd class="ddr2">
				<input class="Wdate" name="statSnapshotResultVo.snapshotTime" id="snapshotTime" type="text" size="10"
					onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'});"
					readonly="readonly" value="${statSnapshotResultVo.snapshotTime}"></input>
			</dd>
		</dl>
		<dl>
