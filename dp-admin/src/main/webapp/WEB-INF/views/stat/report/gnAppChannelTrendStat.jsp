...
<head> 
	...
	<script type="text/javascript" src="js/stat/gnAppChannelTrendStat.js?v=130913"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">APP渠道转化趋势统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tbody>
		<s:iterator value="#request.channelTrendStatList" status="s" id="channelTrendStat">
		<tr>
