...
<head> 
	...
	<script type="text/javascript" src="js/stat/iuniosVersionDistribute.js?v=140213"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">IUNI OS 用户数版本分布统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<s:if test="#request.versionDistributeList != null && !#request.versionDistributeList.isEmpty()">
	...
	<tbody>
		<s:iterator value="#request.versionDistributeList" status="s" id="versionDistribute">
		<tr>
			<td class="mytd"><s:property value="rowNum" /></td>
			<td class="mytd"><s:property value="statDate" /></td>
			<td class="mytd"><s:property value="apkVersion" /></td>
			<td class="mytd"><s:property value="userNum" /></td>
			<td class="mytd"><s:property value="versionRate" /></td>
		</tr>
		</s:iterator>
	</tbody>
	</table>
