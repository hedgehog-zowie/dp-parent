...
<head> 
	...
	<script type="text/javascript" src="js/stat/wxUpwardCtxStat.js?v=130809"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">微信上行内容统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<div class="fl">
		...
		<caption class="cp1">关键字上行排行</caption>
		<thead>
			<tr>
				<th>序号</th>
				<th>内容</th>
		...
		<tbody>
			<s:iterator value="#request.keywordStatList" status="s" id="keywordStat">
			<tr>
				<td class="mytd"><s:property value="rowNum" /></td>
				<td class="mytd"><s:property value="content" /></td>
				<td class="mytd"><s:property value="count" /></td>
			</tr>
			</s:iterator>
		</tbody>
		</table>
	...
	<div class="fr">
		...
		<caption class="cp1">非关键字上行排行</caption>
		<thead>
			<tr>
				<th>序号</th>
				<th>内容</th>
		...
		<tbody>
			<s:iterator value="#request.nonkeywordStatList" status="s" id="nonkeywordStat">
			<tr>
				<td class="mytd"><s:property value="rowNum" /></td>
				<td class="mytd"><s:property value="content" /></td>
				<td class="mytd"><s:property value="count" /></td>
