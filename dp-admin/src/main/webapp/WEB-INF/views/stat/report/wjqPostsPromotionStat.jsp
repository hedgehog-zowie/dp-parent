...
<head> 
	...
	<script type="text/javascript" src="js/stat/wjqPostsPromotionStat.js?v=130824"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">玩机圈帖子推广报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tr> 
		...
		<dl>
			<dd class="ddl1">
				<label for="themeId">帖子主题ID</label>
			</dd>
			<dd class="ddr1">
				<input name="statParams['themeId']" id="userId" type="text" value="${statParams['themeId']}"></input>
			</dd>
			<dd class="ddl1">
	...
	<caption class="cp1">玩机圈帖子推广报表</caption>
	<thead>
		<tr>
			<th>序号</th>
			<th>统计日期</th>
	...
	<tbody>
		<s:iterator value="#request.postsPromotions" status="s" id="postsPromotion">
		<tr>
