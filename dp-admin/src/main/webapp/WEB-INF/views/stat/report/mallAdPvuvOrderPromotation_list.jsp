...
<head> 
	...
	<script type="text/javascript" src="js/stat/mallAdPvuvOrderPromotation_list.js?v=130607"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">站外推广数据报表(推广数据表)</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
		...
		<dl>
			...
			<dd class="ddr1">
				<input class="Wdate1" name="beginDate" id="beginDate" type="text" size="10"
					onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-{%d-22}'});"
	...
	<tbody>
		<s:iterator value="mallAdPvuvOrderDailyList" status="s" id="mallAdPvuvOrderDaily">
		<tr>
		    <td class="mytd"><s:property value="outDate" /></td>
			...
			<td class="mytd"><s:property value="channelPv" /></td>
			<td class="mytd"><s:property value="channelUv" /></td>
			...
			<td class="mytd"><a href="<%=basePath%>stat/queryMallAdPvuvOrderDetails.action?detailType=3&bizDate=${bizDate}&adId=${adId}&adName=${adName}&channelName=${channelName}">查看明细</a></td>
		</tr>
		</s:iterator>
	</tbody>
	</table>
