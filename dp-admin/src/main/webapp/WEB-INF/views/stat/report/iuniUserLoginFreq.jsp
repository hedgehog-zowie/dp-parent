...
<head> 
	...
	<script type="text/javascript" src="js/stat/iuniUserLoginFreq.js?v=140609"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">IUNI用户登陆频次统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tr> 
		...
		<dl>
			<dd class="ddl1" style="width: 10%">
				<label for="beginDate">用户注册日期开始</label>
			</dd>
			<dd class="ddr1">
			...
			<dd class="ddl1" style="width: 10%">
				<label for="endDate">用户注册日期结束</label>
			</dd>
			<dd class="ddr1">
	...
	<tbody>
		<s:iterator value="#request.iuniUserLoginFreqList" status="s" id="iuniUserLoginFreq">
		<tr>
			...
			<td class="mytd"><s:property value="s1day" /></td>
			<td class="mytd"><s:property value="s2to3day" /></td>
			<td class="mytd"><s:property value="s4to7day" /></td>
			<td class="mytd"><s:property value="s8to30day" /></td>
			<td class="mytd"><s:property value="s31to90day" /></td>
		</tr>
		</s:iterator>
	</tbody>
	</table>
