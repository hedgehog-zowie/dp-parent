...
<head> 
	...
	<script type="text/javascript" src="js/stat/iuniNetflowSumTodayStat.js?v=140319"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">IUNI商城流量当天实时汇总统计</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<tbody>
		<s:iterator value="#request.netflowSumTodayList" status="s" id="netflowSumToday">
		<tr>
