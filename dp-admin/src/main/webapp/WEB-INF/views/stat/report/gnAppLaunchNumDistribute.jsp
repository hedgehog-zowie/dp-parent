...
<head> 
	...
	<script type="text/javascript" src="js/stat/gnAppLaunchNumDistribute.js?v=130923"></script>
...
<body> 
	...
	<tr> 
		<td class="td01"></td> 
		<td class="td02"><h3 class="topTitle fb f14">APP渠道启动次数用户分布统计报表</h3></td> 
		<td class="td03"></td> 
	</tr> 
	</tbody> 	
	</table>  
	...
	<s:if test="#request.launchNumDistributeList != null && !#request.launchNumDistributeList.isEmpty()">
...
<!-- 			<th>渠道名</th> -->
	...
	<tbody>
		<s:iterator value="#request.launchNumDistributeList" status="s" id="launchNumDistribute">
		<tr>
			<td class="mytd"><s:property value="rowNum" /></td>
<%-- 			<td class="mytd"><s:property value="channelName" /></td> --%>
			<td class="mytd"><s:property value="launchSection" /></td>
			<td class="mytd"><s:property value="distributeNum" /></td>
			<td class="mytd"><s:property value="distributeRate" /></td>
		</tr>
		</s:iterator>
	</tbody>
	</table>
