...
<body>
	<table border="0" cellspacing="0" cellpadding="0" class="adminMain_top">
		<tbody>
			<tr>
				<td class="td01"></td>
				<td class="td02"><h3 class="topTitle fb f14">修改系统参数</h3></td>
				<td class="td03"></td>
			</tr>
		</tbody>
	</table>
	<form action="<%=request.getContextPath()%>/updateSysParam.action" id="mainFrm" name="mainFrm" method="post">
					...
					<td class="adminMain_wrap">
						<div class="wrapMain"
							...
							<table style="text-align: center;">
								<tr>
									<td align="left">位置 > 系统管理 > 修改系统参数</td>
								</tr>
								<tr>
									<td align="left"><br /></td>
								</tr>
									...
									<td style="width: 1000px;" align="center">
										...
										<table width="1000px;" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td align="left"><br /><br /><input name="sysParam.paramName" id="paramName" readonly value="<s:property value='sysParam.paramName' />"/></td>
											</tr>
											<tr>
												<td align="right" style="width: 50%">参数值：</td>
												<td align="left"><input name="sysParam.paramVal" id="paramVal" value="<s:property value='sysParam.paramVal' />"/></td>
											</tr>
											<tr>
												<td align="right" style="width: 50%">参数描述：</td>
												<td align="left"><input name="sysParam.paramDesc" id="paramDesc" value="<s:property value='sysParam.paramDesc' />" /></td>
											</tr>
											...
											<tr>
												...
												<td align="left">
												<br /><br />
												<input type="button" value=" 修  改  " onclick="updateItem()"/>
