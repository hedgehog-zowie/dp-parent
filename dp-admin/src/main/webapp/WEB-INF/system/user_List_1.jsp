...
<table class="mytable">
	<tr>
		<td align="left">账号名：<input name="user_name" value='<s:property value="user_name" />' /> </td>
	</tr>
</table>
<input type="button" value="  搜  索  " onclick="search()" />&nbsp;&nbsp;<input type="button" value=" 添加管理员账号 " onclick="addAcount()" />
<br/><br/>
</div>
