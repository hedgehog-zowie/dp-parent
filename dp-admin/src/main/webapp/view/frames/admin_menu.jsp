<%-- <%@page import="com.gionee.ias.system.model.Menu"%> --%>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/template/javascript/jquery-huadong.js"></script> 
...
<%
	...
	if (session.getAttribute("user") == null) {
		response.sendRedirect(request.getContextPath()+ "/logout.action");
	} else {
