 ...
 */
package com.iuni.dp.admin.sso.constants;

import com.iuni.dp.persist.common.utils.PropertiesUtil;
...
public class SsoConstant {
	 ...
	 * 与UUC对接的常量
	 */
	public static final String UUC_URL = PropertiesUtil.get("ias.uuc.url");//用户中心地址
...
//	public static final String UUC_FETCH_PERMISSION_URI = "/api/queryStock.action";//取用户权限
	public static final String UUC_APP_WMS_ID = PropertiesUtil.get("ias.uuc.app.id");//WMS在用户中心配置的应用ID
	public static final String UUC_APP_WMS_KEY = PropertiesUtil.get("ias.uuc.app.key");//WMS在用户中心配置的应用ID
}
