...
public class GnAppAccessLog implements Serializable {
	...
	private static final long serialVersionUID = 2294556274620407302L;
	...
	public GnAppAccessLog(String appName, String channelName,
			...
			String mobileModel, String mobileNumber, Integer modelHeight,
			Integer modelWidth, String networkMode, String networkIp,
			String locationCountry, String locationProvince,
			String locationCity, Timestamp locationTime, Timestamp reportTime) {
		super();
		this.appName = appName;
		this.channelName = channelName;
		this.apkVersion = apkVersion;
	...
	public String toString() {
		return "GnAppAccessLog [appName=" + appName + ", channelName="
				...
				+ ", networkIp=" + networkIp + ", locationCountry="
				+ locationCountry + ", locationProvince=" + locationProvince
				+ ", locationCity=" + locationCity + ", locationTime="
				+ locationTime + ", reportTime=" + reportTime + "]";
	}
